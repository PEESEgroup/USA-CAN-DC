...
def main(sw, t, iteration=0):
    ...
    import datacenter as datacenter_processing
    ...
    if len(failed):
        ...
        ### Refresh data-center inputs before GAMS loads the new stress iteration.
        datacenter_processing.refresh_flex_timeseries_inputs(
            reeds_path=sw['reeds_path'],
            inputs_case=os.path.join(sw['casedir'], 'inputs_case'),
        )
