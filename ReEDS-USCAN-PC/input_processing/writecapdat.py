...
TECH = {
    'capnonrsc': [
        ...
        'nuclear', 'nuclear-SMR', 'o-g-s', 'battery_li', 'pumped-hydro'
    ],
    'capnonrsc_energy': [
        'battery_li'
    ],
    'prescribed_nonRSC': [
        ...
        'geothermal', 'biopower', 'coal-igcc', 'nuclear', 'nuclear-SMR',
    ...
    'retirements': [
        ...
        'battery_li','nuclear', 'nuclear-SMR', 'pumped-hydro', 'coal-igcc',
    ],
    'retirements_energy': [
        'battery_li'
    ],
...
def main(reeds_path, inputs_case, agglevel, regions):
    ...
    if (
        os.path.exists(os.path.join(inputs_case, 'can_imports.csv'))
        ...
        can_imports_capacity = pd.Series(dtype=float, name='MW')
        can_imports_capacity.index = pd.MultiIndex.from_arrays([[], []], names=['*r', 't'])
