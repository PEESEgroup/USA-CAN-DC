...
DATACENTER_TRAIN.lo(r,h,t_unfix)$datacenter_r(r) = 0 ;
DATACENTER_TRAIN.up(r,h,t_unfix)$datacenter_r(r) = +inf ;
DATACENTER_INFER.lo(r,h,t_unfix)$datacenter_r(r) = 0 ;
DATACENTER_INFER.up(r,h,t_unfix)$datacenter_r(r) = +inf ;
DATACENTER_TRAIN_REFERENCE.lo(r,h,t_unfix)$datacenter_r(r) = 0 ;
DATACENTER_TRAIN_REFERENCE.up(r,h,t_unfix)$datacenter_r(r) = +inf ;
DATACENTER_TRAIN_FLEX.lo(r,h,t_unfix)$datacenter_r(r) = 0 ;
DATACENTER_TRAIN_FLEX.up(r,h,t_unfix)$datacenter_r(r) = +inf ;
DATACENTER_TRAIN_FLEX_FLOW.lo(r,datacenter_train_route,t_unfix)$datacenter_r(r) = 0 ;
DATACENTER_TRAIN_FLEX_FLOW.up(r,datacenter_train_route,t_unfix)$datacenter_r(r) = +inf ;
DATACENTER_TRAIN_SPATIAL.lo(r,datacenter_train_day,rr,t_unfix)$[datacenter_r(r)$datacenter_r(rr)$datacenter_spatial_route(r,rr)$sum{h$datacenter_train_day_h(datacenter_train_day,h), 1}] = 0 ;
DATACENTER_TRAIN_SPATIAL.up(r,datacenter_train_day,rr,t_unfix)$[datacenter_r(r)$datacenter_r(rr)$datacenter_spatial_route(r,rr)$sum{h$datacenter_train_day_h(datacenter_train_day,h), 1}] = +inf ;
