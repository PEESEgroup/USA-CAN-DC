...
if(Sw_RemoveSmallNumbers = 1,
    ...
    CAP_DATACENTER.l(r,tfix)$[abs(CAP_DATACENTER.l(r,tfix)) < rhs_tolerance] = 0 ;
    INV.l(i,v,r,tfix)$[abs(INV.l(i,v,r,tfix)) < rhs_tolerance] = 0 ;
    INV_DATACENTER.l(r,tfix)$[abs(INV_DATACENTER.l(r,tfix)) < rhs_tolerance] = 0 ;
    INV_DATACENTER_SC.l(r,datacenter_sc_bin,tfix)$[abs(INV_DATACENTER_SC.l(r,datacenter_sc_bin,tfix)) < rhs_tolerance] = 0 ;
...
*     PEAK_FLEX.fx(r,ccseason,tfix)$Sw_EFS_flex = PEAK_FLEX.l(r,ccseason,tfix) ;
    ...
    CAP_DATACENTER.fx(r,tfix)$datacenter_r(r) = CAP_DATACENTER.l(r,tfix) ;
    INV_DATACENTER.fx(r,tfix)$datacenter_r(r) = INV_DATACENTER.l(r,tfix) ;
    INV_DATACENTER_SC.fx(r,datacenter_sc_bin,tfix)$[datacenter_r(r)$datacenter_sc_capacity(r,datacenter_sc_bin)] = INV_DATACENTER_SC.l(r,datacenter_sc_bin,tfix) ;
    DATACENTER_TRAIN.fx(r,h,tfix)$datacenter_r(r) = DATACENTER_TRAIN.l(r,h,tfix) ;
    DATACENTER_INFER.fx(r,h,tfix)$datacenter_r(r) = DATACENTER_INFER.l(r,h,tfix) ;
    DATACENTER_TRAIN_REFERENCE.fx(r,h,tfix)$datacenter_r(r) = DATACENTER_TRAIN_REFERENCE.l(r,h,tfix) ;
    DATACENTER_TRAIN_FLEX.fx(r,h,tfix)$datacenter_r(r) = DATACENTER_TRAIN_FLEX.l(r,h,tfix) ;
    DATACENTER_TRAIN_FLEX_FLOW.fx(r,datacenter_train_route,tfix)$datacenter_r(r) = DATACENTER_TRAIN_FLEX_FLOW.l(r,datacenter_train_route,tfix) ;
    DATACENTER_TRAIN_SPATIAL.fx(r,datacenter_train_day,rr,tfix)$[datacenter_r(r)$datacenter_r(rr)$datacenter_spatial_route(r,rr)$sum{h$datacenter_train_day_h(datacenter_train_day,h), 1}] = DATACENTER_TRAIN_SPATIAL.l(r,datacenter_train_day,rr,tfix) ;
