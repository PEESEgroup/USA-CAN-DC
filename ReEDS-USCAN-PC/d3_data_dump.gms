...
ra_datacenter_load(r,t)            "--MW-- data center total electric load by region"
...
ra_datacenter_load(r,t)$[tcur(t)$datacenter_r(r)] =
    sum{h$h_rep(h), hours(h) * datacenter_pue_r(r,t)
        * (datacenter_rho_idle * CAP_DATACENTER.l(r,t)
           + DATACENTER_TRAIN.l(r,h,t)
           + DATACENTER_INFER.l(r,h,t)) } / 8760 ;
