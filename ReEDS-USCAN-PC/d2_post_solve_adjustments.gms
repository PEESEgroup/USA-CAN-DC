...
*** Record this year's realized (solved) data-center supply-curve occupancy
*** so d1_datacenter_sc_fill.gms can fill next year's exogenous bins using
*** capacity actually still available, rather than a bin assignment
*** precomputed before any solve took place.
datacenter_sc_occupied_total(r,datacenter_sc_bin)$datacenter_r(r) =
    datacenter_sc_occupied_total(r,datacenter_sc_bin)
    + INV_DATACENTER_SC.l(r,datacenter_sc_bin,"%cur_year%")
