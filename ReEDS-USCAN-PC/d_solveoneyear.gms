...
*** Fill this year's retained-exogenous data-center supply-curve bins using
*** realized occupancy from prior years (must run before the solve below)
$include d1_datacenter_sc_fill.gms
